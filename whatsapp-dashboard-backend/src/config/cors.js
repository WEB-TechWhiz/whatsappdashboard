...
const CORS_NOT_ALLOWED = "CORS_NOT_ALLOWED";
...
const allowedOriginEntries = splitList(process.env.FRONTEND_ORIGIN || DEFAULT_FRONTEND_ORIGIN);
const allowedOrigins = allowedOriginEntries.filter((origin) => !origin.includes("*"));
const allowedOriginPatterns = [
  ...allowedOriginEntries.filter((origin) => origin.includes("*")),
  ...splitList(process.env.FRONTEND_ORIGIN_PATTERNS),
];
