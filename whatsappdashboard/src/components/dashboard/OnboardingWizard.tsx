...
export function OnboardingWizard({
  ...
  return (
    <Dialog open={open} onOpenChange={(nextOpen) => !mandatory && onOpenChange(nextOpen)}>
      <DialogContent
      ...
      >
        <div className="shrink-0 bg-gradient-to-br from-primary/10 via-background to-background px-6 pt-6 pb-4 border-b">
